    ...
    <div class="jumbotron">
        <form method="post" action="{{ route('premieres.store') }}">
            ...
            <div class="col-4">
                ...
                <input value="{{$premiere->start}}" class="form-control" type="datetime-local" name="start" id="" required>
            </div>

            <div class="col-4">
                <label for="">Final de función:</label>
                <input value="{{$premiere->end}}" class="form-control" type="datetime-local" name="end" id="" required>
            </div>
    
            <div class="col-4">
                <label for="">Disponible:</label>
                <select class="form-control" name="available" id="">
                    <option value="{{$premiere->available}}">{{$premiere->available}}Elija una opción</option>
            ...
            <div class="col-4">
                ...
                <select class="form-control" name="type" id="">
                    <option value="{{$premiere->type}}">{{$premiere->type}}Elija un turno</option>
