...
class GraficasController extends Controller
{
    ...
    public function graficarFunciones(){
        $premieres = Premiere::select(\DB::raw("COUNT(*) as count"))->whereYear('created_at', date('Y'))->groupBy(\DB::raw("Month(created_at)"))->pluck('count');
        return view('graficas.graficarFunciones', compact('premieres')); 
    }
}